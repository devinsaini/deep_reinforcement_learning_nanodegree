...
2. Place the file in the DRLND GitHub repository, in the `p3_collab-compet/` folder, and unzip (or decompress) the file. Enter the path of the file in the `Tennis.ipynb` notebook while initializing the environment.
   ```
